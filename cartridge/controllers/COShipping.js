...
var rex = new RegExp((/^(^\d{5}(-\d{4})?$)|(^[abceghjklmnprstvxyABCEGHJKLMNPRSTVXY]{1}\d{1}[A-Za-z]{1} *\d{1}[A-Za-z]{1}\d{1}$)$/));  
/* Script Modules */
...
function start() {
    ...
    if (cart.getDefaultShipment().getShippingAddress()) {
        ...
        if(basket.custom.PaypalAddressData ) {
            app.getForm('singleshipping').object.shippingAddress.addressFields.firstName.value=basket.custom.PaypalAddressData.split('`')[0];
            app.getForm('singleshipping').object.shippingAddress.addressFields.lastName.value=basket.custom.PaypalAddressData.split('`')[1];
            app.getForm('singleshipping').object.shippingAddress.addressFields.address1.value=basket.custom.PaypalAddressData.split('`')[2];
            app.getForm('singleshipping').object.shippingAddress.addressFields.address2.value=basket.custom.PaypalAddressData.split('`')[3] !='undefined' ?  basket.custom.PaypalAddressData.split('`')[3] : '';
            app.getForm('singleshipping').object.shippingAddress.addressFields.city.value=basket.custom.PaypalAddressData.split('`')[4];
            app.getForm('singleshipping').object.shippingAddress.addressFields.postal.value=rex.test(basket.custom.PaypalAddressData.split('`')[5]) == true ? basket.custom.PaypalAddressData.split('`')[5] :'';
            app.getForm('singleshipping').object.shippingAddress.addressFields.states.state.value=basket.custom.PaypalAddressData.split('`')[7];
            //basket.custom.PaypalAddressData.split('`')[6] != 'us' ? 'AL' :basket.custom.PaypalAddressData.split('`')[7];
            app.getForm('singleshipping').object.shippingAddress.addressFields.country.value=basket.custom.PaypalAddressData.split('`')[6];
            // basket.custom.PaypalAddressData.split('`')[6] != 'us' ? 'us':basket.custom.PaypalAddressData.split('`')[6];
            app.getForm('singleshipping').object.shippingAddress.addressFields.shippingEmail.value = basket.custom.PaypalAddressData.split('`')[8];
            app.getForm('singleshipping').object.shippingAddress.addressFields.phone.value=basket.custom.PaypalAddressData.split('`')[9];
        ...
        //Custom condition to check if the shipping email is present
        ...
        else if(basket.customerNo == null) {
            //GUEST Condition 
            if(basket.custom.PaypalAddressData){
                app.getForm('singleshipping').object.shippingAddress.addressFields.firstName.value=basket.custom.PaypalAddressData.split('`')[0];
                app.getForm('singleshipping').object.shippingAddress.addressFields.lastName.value=basket.custom.PaypalAddressData.split('`')[1];
