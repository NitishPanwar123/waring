...
function Handle(args) {
    ...
    if (creditCardStatus.error) {
        ...
        var invalidatePaymentCardFormElements = require('app_babyliss_fr/cartridge/scripts/checkout/InvalidatePaymentCardFormElements');
...
function Authorize(args) {
    if("666"===app.getForm('billing.paymentMethods.creditCard').get('cvn').value()){
